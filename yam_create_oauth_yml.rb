...
# Upon successful registration, you'll receive your consumer key and secret.
...
puts "Please visit the following URL in your browser to authorize your application,\nthen enter the 4 character security code when done:\n#{request_token.authorize_url}"
oauth_verifier = gets
